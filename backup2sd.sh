...
copy_with_multiple_methods "/dev" "$BACKUP_DIR" "Device files (virtual filesystem)"
...
copy_with_multiple_methods "/proc" "$BACKUP_DIR" "Process information (virtual filesystem)"
...
copy_with_multiple_methods "/sys" "$BACKUP_DIR" "System information (virtual filesystem)"
